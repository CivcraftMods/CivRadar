...
---
1. Run Minecraft 1.10 at least once (not 1.10.x, just regular 1.10)
2. Download the [Forge 1.10-12.18.0.1983 Installer](http://files.minecraftforge.net/maven/net/minecraftforge/forge/1.10-12.18.0.1983-1.10.0/forge-1.10-12.18.0.1983-1.10.0-installer.jar) or [another version](http://files.minecraftforge.net) (OTHER VERSIONS ARE NOT OFFICIALLY SUPPORTED BUT MAY WORK)
...
7. Create a new profile and select the version 'release Forge 1.10-12.18.0.1983-1.10.0'
